  ...
  return (
    ...
    >
      <motion.div className="user-info" variants={fadeInAnimationVariants}>
        ...
        <motion.div variants={fadeInAnimationVariants} className="download"> <a href="https://drive.google.com/file/d/1yk8UF01bEQC13TtMPhkuIcGV-m_4ix_R/view?usp=sharing" target="_blank"> Download CV <FontAwesomeIcon icon="fa-solid fa-download" className='downloadFA' /></a></motion.div>
      </motion.div>
